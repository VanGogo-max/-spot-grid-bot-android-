...
# Активни борси — можеш да ограничиш до една, ако искаш
EXCHANGES = [
    MEXCSpot(),
    GateIOSpot(),
    KuCoinSpot(),
...
BALANCE_REPORT_INTERVAL = 6 * 3600  # на всеки 6 часа

# --- НОВА ФУНКЦИЯ: Отчет за баланс ---
def report_balances():
    total_usdt = 0.0
...
def main():
    ...
    # ⭐ ОТЧЕТ ПРИ СТАРТИРАНЕ
    time.sleep(2)
    report_balances()

    while True:  # 🔁 ТОВА Е БЕЗКРАЙНИЯТ ЦИКЪЛ
        try:
